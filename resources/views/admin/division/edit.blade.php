        ...
        <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb" data-appear-animation="fadeInRight" data-appear-delay="600">
                    ...
                    <li class="active"><a href="{{route('division.create')}}"><i class="fa fa-edit"></i> Edit Division</a></li>
                </ol>
                ...
                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    {!!Form::model($division,['route'=>['division.update',$division->slug],'method'=>'put','class'=>'showSavingOnSubmit','files'=>true])!!}
                            ...
                            <div class="panel-body collapse in" id="pro_collapse_division">
                                ...
                                <div class="form-group col-md-6 col-lg-6 @if($errors->has('districts')) has-error @elseif(count($errors->all())>0) has-success @endif has-feedback">
                                    <div class="input-group pro_make_full showToolTip">
                                        ...
                                        <input type="text" class="form-control" id="districts" name="districts" value="@foreach($division->districts as $district) {{$district->name}}, @endforeach" />
