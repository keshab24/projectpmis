        ...
        <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb" data-appear-animation="fadeInRight" data-appear-delay="600">
                    ...
                    <li class="active"><a href="{{route('implementingmode.edit', $implementingmode->slug)}}"><i class="fa fa-edit"></i> Edit Implementing Mode</a></li>
                </ol>

                <div class="pro_helpers" data-appear-animation="fadeInDown" data-appear-delay="800">
                    <div class="col-lg-6 col-md-6">
                        <a href="{{route('implementingmode.index')}}" class="btn btn-info showToolTip" title="Edit Implementing Mode" role="button" data-placement="top"><span class="glyphicon glyphicon-eye-open"></span> <span class="hidden-xs hidden-sm">Show Budget Topics</span></a>
                        <a href="{{route('implementingmode.create')}}" class="btn btn-warning showToolTip" title="Add Budget Topic" role="button" data-placement="top"><span class="glyphicon glyphicon-edit"></span> <span class="hidden-xs hidden-sm">Edit Implementing Mode</span></a>
                    </div>
                    <div class="clearfix"></div>
                </div>

                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    {!!Form::model($implementingmode, ['route'=>['implementingmode.update', $implementingmode->slug],'method'=>'put','class'=>'showSavingOnSubmit','files'=>true])!!}
                            ...
                            <div class="panel-body collapse in" id="pro_collapse_implementingmode">
                                ...
                                <div class="form-group col-md-6 col-lg-6 @if($errors->has('name')) has-error @elseif(count($errors->all())>0) has-success @endif has-feedback">
                                    <div class="input-group pro_make_full showToolTip">
                                        {!! Form::label('name','अायाेजना लागु हुने कार्यालयकाे नामह्:') !!}
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body collapse in" id="pro_collapse_implementingmode_save">
                                ...
                                <div class="form-group col-md-6 col-lg-6 pro_checkbox pro_no_top">
                                    <input type="checkbox" name="status" id="status" class="first_color" @if($implementingmode->status == 1 ) checked="checked" @endif />
