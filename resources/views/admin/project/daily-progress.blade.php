...
@section('content')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <a href="{{route('report.daily.progress',$project->id)}}"><i class="fa fa-eye"></i> View Daily Progress</a>
        </li>
    </ol>
    ...
    <div class="container-fluid">
        ...
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-lg-2 col-md-2 pull-right">
                ...
                <input  name="date" type="text" class="form-control nepaliDate" value="{{ dateBS(date('Y-m-d')) }}" id="date" />
            </div>
        </div>
