...
@section('headerContent')
    ...
    <style>
        ...
        @media all and (min-width: 480px) {
            ...
            .pro_images_section label,
            .pro_files_section label {
                margin-top: 0%;
                height: 50px;
            ...
            .pro_images_section label:hover,
            .pro_files_section label:hover {
                background: #dddddd;
            }

            .pro_images_section label:active,
            .pro_files_section label:active {
                cursor: -webkit-grabbing;
                cursor: grabbing;
            }

            .pro_images_section input[type=file],
            .pro_files_section input[type=file] {
                display: none;
            }

            .pro_images_section label.noBorder,
            .pro_files_section label.noBorder {
                border: none;
            }

            .pro_images_section label span,
            .pro_files_section label span {
                margin-top: 10px;
            }

            .pro_images_section label img,
            .pro_files_section label img {
                max-width: 100%;
                max-height: 100%;
            }

            .pro_images_section input[type=button],
            .pro_files_section input[type=button] {
                position: absolute;
                top: 0;
            }

            .pro_images_section input,
            .pro_files_section input {
                margin-bottom: 10px;
            }

            .pro_images_section .file_icon,
            .pro_files_section .file_icon {
                color: #387fb9;
                padding-top: 32px;
            }

            .pro_images_section .i_file_name,
            .pro_files_section .i_file_name {
                font-size: 12px;
                overflow: hidden;
            }

            .pro_images_section .iframePdf,
            .pro_files_section .iframePdf {
                width: 100%;
                height: 100%;
            }
        }
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="pro_helpers" data-appear-animation="fadeInDown" data-appear-delay="800">
                    <div class="col-lg-6 col-md-6">
                        <a href="{{ route('project.index') }}/search?search={{ $setting->project_code }}"
                            class="btn btn-warning showToolTip" title="Back To Index" role="button"
                            data-placement="top"><span class="glyphicon glyphicon-chevron-left"></span><span
                                class="hidden-xs hidden-sm"> Back</span></a>
                        <a href="{{ route('project.index') }}" class="btn btn-info showToolTip" title="View All Projects"
                            role="button" data-placement="top"><span class="glyphicon glyphicon-eye-open"></span> <span
                                class="hidden-xs hidden-sm">Projects</span></a>
                    </div>
                ...
                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    ...
                    <div class="col-md-8 col-lg-8" data-appear-animation="fadeInRight" data-appear-delay="1200">
                        ...
                        @foreach (manpowerTypes() as $index => $manpower_type)
                            <div {{ restrictToImplementingOffice() }} class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title pull-left"><i class="fa fa-file"></i>{{ $manpower_type }}
                                    </h3>
                                ...
                                <div class="panel-body collapse" id="pro_project_engineers{{ $index }}">
                                    ...
                                    @elseif($manpower_type == 'Contractor')
                                        <div class="input-group pro_make_full showToolTip">
                        ...
                        @if (Auth::user()->implementing_office_id === 410)
                            <div {{ restrictToImplementingOffice() }} class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title pull-left"><i class="fa fa-file"></i> Daily Progress User
                                        Management</h3>
                                ...
                                <div class="panel-body collapse" id="pro_project_daily_progress_users">
                                    ...
                                    ?>
                                    <div
                                        class="form-group col-md-12 col-lg-12 @if ($errors->has('users')) has-error @elseif(count($errors->all()) > 0) has-success @endif has-feedback">
                                        <div class="input-group pro_make_full showToolTip">
            ...
            $('#cancelledForm').submit(function(e) {
                ...
                if ($project_code === $(this).attr('data-project-id')) {
                    ...
                    if (cancelled_remarks == '' || cancelled_remarks == '0000-00-00') {
                        ...
                        $('#cancelled_remarks_error_on_finish').html(
                            'Please Enter Project Cancelled remark');
                        return false;
                    } else {
    ...
    <script type="text/javascript">
        ...
        function addFiles(input, index) {
            $(input).closest('.pro_files_browser').append('<div class=" col-md-4 col-lg-4 pro_files_section">' +
                ...
                '                                                    <label class="photo_label" for="file' + y +
                '"><span class="fa fa-plus-square"></span> Add a' +
                '                                                        File</label>' +
                '                                                    <input type="file" name="file' + index +
                '[]" onchange="readFileURL(this)" index="' + index + '"' +
                '                                                           class="form-control" id="file' + y +
                '" multiple />' +
                '                                                    <input type="text" style="width: 75px; font-size: small;" name="file' +
                index + '_date[]" class="nepaliDate"' +
                '                                                           id="' + y +
