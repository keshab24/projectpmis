    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb" data-appear-animation="fadeInRight" data-appear-delay="600">
                ...
                <li class="active"><a href="{{route('progresstrack-block.index', $project->id)}}"><span class="glyphicon glyphicon-list"></span> Progress Track</a></li>
            </ol>
            ...
            <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                <div class="pro_helpers" data-appear-animation="fadeInDown" data-appear-delay="800">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-2">
                        <a href="{{route('progresstrack-block.create',$project->id)}}" class="btn btn-warning showToolTip pull-left" title="Add Progresstrack" role="button"><span class="glyphicon glyphicon-plus"></span> Add Progress Track</a>
...
{{--                        </div><!-- /input-group -->--}}
                    ...
                    {!! Form::close() !!}
                    <div class="col-md-5 col-lg-5 col-sm-5">
{{--                        <a href="{{route('progresstrack-block.index')}}?trashes=yes" class="btn btn-danger showToolTip pull-right" title="Trashes" role="button"><span class="fa fa-trash"></span> <span class="badge">{{$trashes_no}}</span></a>--}}
                    ...
                    <div class="">
                        <table class="table table-striped table-hover">
                            ...
                            <tr>
                                ...
                                <td>{{ $progresstrack->block->block_name ?? '' }}</td>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-xs btn-warning" href="{{ route('progresstrack-block.edit',[$project->id,$progresstrack->id]) }}"><span class="fa fa-pencil"></span></a>
                                    ...
                                    {!! delete_form(['progresstrack-block.destroy',$progresstrack->id], 'pro_my_form'.$i++) !!}
                                    @else
                                    <a href="{{route('restore',['Progresstrack',$progresstrack->id])}}" class="btn btn-xs btn-success showToolTip" title="Restore" role="button"><span class="fa fa-reply"></span></a>&nbsp;
                                    ...
                                    {!! hard_delete_form(['progresstrack.destroy',$progresstrack->id], 'pro_my_form'.$i++) !!}
                                    @endif
                                </td>
                            </tr>
                            @endforeach
