        ...
        <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb" data-appear-animation="fadeInRight" data-appear-delay="600">
                    ...
                    <li><a href="{{route('progresstrack-block.index', $project->id)}}"><i class="fa fa-buysellads"></i> Progresstrack</a></li>
                    <li class="active"><a href="{{route('progresstrack-block.create', $project->id)}}"><i class="fa fa-plus"></i> Add Progresstrack</a></li>
                </ol>

                <div class="pro_helpers" data-appear-animation="fadeInDown" data-appear-delay="800">
                    <div class="col-lg-6 col-md-6">
                        <a href="{{route('progresstrack-block.index', $project->id)}}" class="btn btn-info showToolTip" title="Show Progresstrack" role="button" data-placement="top"><span class="glyphicon glyphicon-eye-open"></span> <span class="hidden-xs hidden-sm">Show Progresstracks</span></a>
                    </div>
                    <div class="clearfix"></div>
                </div>

                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    {!!Form::open(['route'=>['progresstrack-block.store',$project->id],'method'=>'post','class'=>'showSavingOnSubmit','files'=>true])!!}
                    <div class="col-md-8 col-lg-8" data-appear-animation="fadeInLeft" data-appear-delay="1200">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title pull-left"><span class="glyphicon glyphicon-plus"></span> Add Progress Track - {{ $project->name ?? '' }}</h3>
                            ...
                            <div class="panel-body collapse in" id="pro_collapse_progresstrack">
                                ...
                                <div class="form-group col-md-6 col-lg-6 @if($errors->has('block_id')) has-error @elseif(count($errors->all())>0) has-success @endif has-feedback">
                                    <div class="input-group pro_make_full showToolTip">
                                        ...
                                        {!! Form::select('block_id', $project_blocks, isset($_GET['on'])?$_GET['on']:'', ['class'=>'form-control','required']) !!}
