        ...
        <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb" data-appear-animation="fadeInRight" data-appear-delay="600">
                    ...
                    <li class="active"><a href="{{route('budgettopic.edit', $budgettopic->slug)}}"><i class="fa fa-edit"></i> Edit Budget Topic</a></li>
                </ol>
                ...
                <div class="pro_helpers" data-appear-animation="fadeInDown" data-appear-delay="800">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <a href="{{route('budgettopic.create')}}" class="btn btn-warning showToolTip" title="Add Budget Topic" role="button" data-placement="top"><span class="glyphicon glyphicon-edit"></span> <span class="hidden-xs hidden-sm">Add Budget Topic</span></a>
                    </div>
                    <div class="clearfix"></div>
                </div>

                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    {!!Form::model($budgettopic, ['route'=>['budgettopic.update', $budgettopic->slug],'method'=>'put','class'=>'showSavingOnSubmit','files'=>true])!!}
                            ...
                            <div class="panel-body collapse in" id="pro_collapse_budgettopic">
                                ...
                                <div class="form-group col-md-6 col-lg-6 @if($errors->has('budget_head')) has-error @elseif(count($errors->all())>0) has-success @endif has-feedback">
                                    <div class="input-group pro_make_full showToolTip">
                                        ...
                                        {!! Form::text('budget_head', $budgettopic->getOriginal('budget_head'), ['class'=>'form-control','required'=>'required']) !!}
                                ...
                                <div class="form-group col-md-6 col-lg-6 @if($errors->has('budget_head_eng')) has-error @elseif(count($errors->all())>0) has-success @endif has-feedback">
                                    <div class="input-group pro_make_full showToolTip">
                                        ...
                                        {!! Form::text('budget_head_eng', $budgettopic->getOriginal('budget_head_eng'), ['class'=>'form-control','required'=>'required']) !!}
                                ...
                                <div class="form-group col-md-6 col-lg-6 @if($errors->has('budget_topic_num')) has-error @elseif(count($errors->all())>0) has-success @endif has-feedback">
                                    <div class="input-group pro_make_full showToolTip">
                                        ...
                                        {!! Form::text('budget_topic_num', $budgettopic->getOriginal('budget_topic_num'), ['class'=>'form-control','required'=>'required']) !!}
                                ...
                                <div class="form-group col-md-6 col-lg-6 @if($errors->has('priority')) has-error @elseif(count($errors->all())>0) has-success @endif has-feedback">
                                    <div class="input-group pro_make_full showToolTip">
                                        ...
                                        {!! Form::select('priority', $priorities, $budgettopic->getOriginal('priority'), ['class'=>'form-control']) !!}
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body collapse in" id="pro_collapse_budgettopic_save">
                                ...
                                <div class="form-group col-md-6 col-lg-6 pro_checkbox pro_no_top">
                                    <input type="checkbox" name="status" id="status" class="first_color" @if($budgettopic->status == 1 ) checked="checked" @endif />
