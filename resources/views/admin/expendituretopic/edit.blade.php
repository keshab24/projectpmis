        ...
        <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb" data-appear-animation="fadeInRight" data-appear-delay="600">
                    ...
                    <li class="active"><a href="{{route('expendituretopic.edit', $expendituretopic->slug)}}"><i class="fa fa-edit"></i> Edit Expenditure Topic</a></li>
                </ol>

                <div class="pro_helpers" data-appear-animation="fadeInDown" data-appear-delay="800">
                    <div class="col-lg-6 col-md-6">
                        <a href="{{route('expendituretopic.index')}}" class="btn btn-info showToolTip" title="Show Expenditure Topic" role="button" data-placement="top"><span class="glyphicon glyphicon-eye-open"></span> <span class="hidden-xs hidden-sm">Show Expenditure Topics</span></a>
                        <a href="{{route('expendituretopic.create')}}" class="btn btn-warning showToolTip" title="Add Expenditure Topic" role="button" data-placement="top"><span class="glyphicon glyphicon-edit"></span> <span class="hidden-xs hidden-sm">Add Expenditure Topic</span></a>
                    </div>
                    <div class="clearfix"></div>
                </div>

                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    {!!Form::model($expendituretopic, ['route'=>['expendituretopic.update', $expendituretopic->slug],'method'=>'put','class'=>'showSavingOnSubmit','files'=>true])!!}
                    ...
                    <div class="col-md-4 col-lg-4 pro_content_right" data-appear-animation="fadeInRight" data-appear-delay="1200">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body collapse in" id="pro_collapse_tree">
                                <ul class="tree">
                                    <li>
                                        <div class="click_menu @if($expendituretopic->parent_id == 1)click_menu_active @endif" data-menu-id="1" data-menu-level="0" data-menu-order="0">
                                        ...
                                        <ul>
                                            @foreach($expenditure_topics as $expenditure_topic)
                                                @if($expenditure_topic->level == 1)
                                                    <li>
                                                        <div class="click_menu @if($expendituretopic->parent_id == $expenditure_topic->id)click_menu_active @endif" data-menu-id="{!! $expenditure_topic['id'] !!}" data-menu-level="{!! $expenditure_topic['level'] !!}" data-menu-order="{!! $expenditure_topic['order'] !!}">
                                ...
                                {!! Form::hidden('expenditure_topic_id',$expendituretopic->id,['id'=>'expenditure_topic_id']) !!}
                                {!! Form::hidden('level',$expendituretopic->level,['id'=>'level']) !!}
                            </div>
                        </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body collapse in" id="pro_collapse_expendituretopic_save">
                                ...
                                <div class="form-group col-md-6 col-lg-6 pro_checkbox pro_no_top">
                                    <input type="checkbox" name="status" id="status" class="first_color" @if($expendituretopic->status == 1 ) checked="checked" @endif />
