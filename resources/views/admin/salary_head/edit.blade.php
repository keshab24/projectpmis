        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    {!!Form::model($salaryhead, ['route'=>['salaryhead.update', $salaryhead->slug],'method'=>'put','class'=>'showSavingOnSubmit','files'=>true])!!}
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body collapse in" id="pro_collapse_salaryhead">
                                ...
                                <div class="form-group col-md-6 col-lg-6 pro_checkbox pro_no_top">
                                    <input type="checkbox" name="taxable" id="taxable" class="first_color" @if($salaryhead->taxable == 1) checked @endif/>
                                    <label for="taxable">Taxable?</label>
                                </div>
                                <!-- deductable -->
                                <div class="form-group col-md-6 col-lg-6 pro_checkbox pro_no_top">
                                    <input type="checkbox" name="deductable" id="deductable" class="first_color" @if($salaryhead->deductable == 1) checked @endif/>
                            ...
                            <div class="panel-body collapse in" id="pro_collapse_salaryhead_save">
                                ...
                                <div class="form-group col-md-3 col-lg-3 pro_checkbox pro_no_top">
                                    <input type="checkbox" name="status" id="status" class="first_color"
                                           @if($salaryhead->status  == 1) checked @endif/>
