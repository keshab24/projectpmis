        ...
        <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb" data-appear-animation="fadeInRight" data-appear-delay="600">
                    ...
                    <li class="active"><a href="{{route('material.create')}}"><i class="fa fa-plus"></i> Add Material</a></li>
                </ol>
                ...
                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    {!!Form::open(['route'=>'material.store','method'=>'post','class'=>'showSavingOnSubmit'])!!}
