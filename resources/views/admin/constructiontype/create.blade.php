        ...
        <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb" data-appear-animation="fadeInRight" data-appear-delay="600">
                    ...
                    <li class="active"><a href="{{route('constructiontype.create')}}"><i class="fa fa-plus"></i> Add Construction Type</a></li>
                </ol>

                <div class="pro_helpers" data-appear-animation="fadeInDown" data-appear-delay="800">
                    <div class="col-lg-6 col-md-6">
                        <a href="{{route('constructiontype.index')}}" class="btn btn-info showToolTip" title="Edit Construction Type" role="button" data-placement="top"><span class="glyphicon glyphicon-eye-open"></span> <span class="hidden-xs hidden-sm">Show Construction Type</span></a>
                    </div>
                    <div class="clearfix"></div>
                </div>

                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    {!!Form::open(['route'=>'constructiontype.store','method'=>'post','class'=>'showSavingOnSubmit','files'=>true])!!}
                    <div class="col-md-8 col-lg-8" data-appear-animation="fadeInLeft" data-appear-delay="1200">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body collapse in" id="pro_collapse_constructiontype">
                                ...
                                <!-- expenditure_type -->
                                <div class="form-group col-md-6 col-lg-6 @if($errors->has('expenditure_type')) has-error @elseif(count($errors->all())>0) has-success @endif has-feedback">
                                    <div class="input-group pro_make_full showToolTip">
                                        {!! Form::label('expenditure_type','Expenditure Type:') !!}
                                        {!! Form::select('expenditure_type', ['Recurrent'=>'चालु','Capital'=>'पुजीगत'],'Recurrent',['class'=>'form-control']) !!}
                                        @if($errors->has('expenditure_type'))
                                            <span class="glyphicon glyphicon-remove-circle form-control-feedback" aria-hidden="true"></span>
                                            <span id="expenditure_typeStatus" class="sr-only">(error)</span>
                                            <div class="alert alert-danger"><small><i class="fa fa-warning"></i> {!! $errors->first('expenditure_type') !!}</small></div>
                                        @elseif(count($errors->all())>0)
                                            <span class="glyphicon glyphicon-ok-circle form-control-feedback" aria-hidden="true"></span>
                                            <span id="expenditure_typeStatus" class="sr-only">(success)</span>
                                        @endif
                                    </div>
                                </div>
