    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb" data-appear-animation="fadeInRight" data-appear-delay="600">
                ...
                <li class="active"><a href="{{route('engineers.index')}}"><span class="glyphicon glyphicon-list"></span> Human Resource's Info</a></li>
            </ol>
            <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                <div class="pro_helpers" data-appear-animation="fadeInDown" data-appear-delay="800">
                    {!! Form::open(['route'=>'engineers.index','method'=>'get']) !!}
                    <div class="col-lg-2 col-md-2 col-sm-2">
                        <a href="{{route('engineers.create')}}" class="btn btn-warning showToolTip pull-left" title="Add Human Resource" role="button"><span class="glyphicon glyphicon-plus"></span> Add Human Resource's Info</a>
                    </div>
                    ...
                    {!! Form::close() !!}
                    <div class="col-md-5 col-lg-5 col-sm-5">
                        <a href="{{route('engineers.index')}}?trashes=yes" class="btn btn-danger showToolTip pull-right" title="Trashes" role="button"><span class="fa fa-trash"></span> <span class="badge">{{$trashes_no}}</span></a>
                    ...
                    <div class="">
                        <table class="table table-striped table-hover">
                            <tr>
                                ...
                                <th width="10%">
                                    <a href="{{route('engineers.index').'?orderBy=category&order='.$order.$other_data}}" class="sortText showToolTip" title="Sort By Category">Category</a>
                                </th>
                                 <th width="10%">
                                    <a href="{{route('engineers.index').'?orderBy=type&order='.$order.$other_data}}" class="sortText showToolTip" title="Sort By Designation">Designation</a>
                                </th>
                                <th width="10%">
                                    <a href="{{route('engineers.index').'?orderBy=home_address&order='.$order.$other_data}}" class="sortText showToolTip" title="Sort By Address">Address</a>
                                </th>
                                <th width="10%">
                                    <a href="{{route('engineers.index').'?orderBy=email&order='.$order.$other_data}}" class="sortText showToolTip" title="Sort By Email">Email</a>
                                </th>
                                <th width="10%">
                                    <a href="{{route('engineers.index').'?orderBy=mobile&order='.$order.$other_data}}" class="sortText showToolTip" title="Sort By Phone">Mobile</a>
                                </th>
                                <th width="10%">
                                    <a href="{{route('engineers.index').'?orderBy=created_at&order='.$order.$other_data}}" class="sortText showToolTip" title="Sort By Created Date">Created At</a>
                                </th>
                                <th width="10%">
                                    <a href="{{route('engineers.index').'?orderBy=updated_at&order='.$order.$other_data}}" class="sortText showToolTip" title="Sort By Last Modified">Last Modified</a>
                                </th>
                                <th width="5%">
                                    <a href="{{route('engineers.index').'?orderBy=status&order='.$order.$other_data}}" class="sortText showToolTip" title="Sort By Status">Status</a>
                                </th>
                            ...
                            <tr>
                                <td colspan="12">
                                    <div class="alert alert-warning" role="alert">Please add some Human Resources first!!</div>
                                </td>
                            </tr>
                            @else
                            ...
                            <tr>
                                <td>
                                    <div class="form-group col-md-12 col-lg-12 pro_checkbox showToolTip" title="Select">
                                        <input type="checkbox" name="select_item[]" id="select_item{{$i}}" class="select_me third_color" data-menu-id="{{$engineer->id}}" />
                                ...
                                <td>
                                    <div class="index_image_thumb">
                                        ...
                                        <img src="{{asset('public/images/engineer/thumbnail/thumbvtx'.$engineer->image)}}" alt="{{$engineer->image}}" title="{{$engineer->name}}" class="img-thumbnail" />
                                        @else
                                ...
                                <td>{{manpowerTypes()[$engineer->category == 0 ? 1 : $engineer->category]}}</td>
                                <td>{{$engineer->type}}</td>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-xs btn-warning" href="{{ route('engineers.edit',$engineer->slug) }}"><span class="fa fa-pencil"></span></a>
{{--
