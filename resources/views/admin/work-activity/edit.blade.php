        ...
        <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb" data-appear-animation="fadeInRight" data-appear-delay="600">
                    ...
                    <li><a href="{{route('work-activity.index')}}"><i class="fa fa-buysellads"></i> Work Aactivity</a></li>
                    <li class="active"><a href="{{route('work-activity.edit', $material->id)}}"><i class="fa fa-edit"></i> Edit Work Aactivity</a></li>
                </ol>

                <div class="pro_helpers" data-appear-animation="fadeInDown" data-appear-delay="800">
                    <div class="col-lg-6 col-md-6">
                        <a href="{{route('work-activity.index')}}" class="btn btn-info showToolTip" title="Edit WorkAactivity" role="button" data-placement="top"><span class="glyphicon glyphicon-eye-open"></span> <span class="hidden-xs hidden-sm">Show Work Activities</span></a>
                        <a href="{{route('work-activity.create')}}" class="btn btn-warning showToolTip" title="Add WorkAactivity" role="button" data-placement="top"><span class="glyphicon glyphicon-plus"></span> <span class="hidden-xs hidden-sm">Add WorkAactivity</span></a>
                    </div>
                    <div class="clearfix"></div>
                </div>

                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    {!!Form::model($material, ['route'=>['work-activity.update', $material->id],'method'=>'put','class'=>'showSavingOnSubmit','files'=>true])!!}
                    <div class="col-md-8 col-lg-8" data-appear-animation="fadeInLeft" data-appear-delay="1200">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title pull-left"><span class="glyphicon glyphicon-plus"></span> Add WorkAactivity</h3>
                                {!! minimizeButton('pro_collapse_material') !!}
                            </div>
                            <div class="panel-body collapse in" id="pro_collapse_material">
                            ...
                            <div class="form-group col-md-6 col-lg-6 @if($errors->has('code')) has-error @elseif(count($errors->all())>0) has-success @endif has-feedback">
                                <div class="input-group pro_make_full showToolTip" @if($errors->has('code')) title="{!!$errors->first('code')!!}" @endif>
                    ...
                    <div class="col-md-4 col-lg-4 pro_content_right" data-appear-animation="fadeInRight" data-appear-delay="1200">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                {!! minimizeButton('pro_collapse_material_save') !!}
                            </div>
                            <div class="panel-body collapse in" id="pro_collapse_material_save">
                                ...
                                <div class="form-group col-md-6 col-lg-6 pro_checkbox pro_no_top">
                                    <input type="checkbox" name="status" id="status" class="first_color" @if($material->status == 1 ) checked="checked" @endif />
