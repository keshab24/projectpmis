        ...
        <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb" data-appear-animation="fadeInRight" data-appear-delay="600">
                    ...
                    <li class="active"><a href="{{route('implementingoffice.create')}}"><i class="fa fa-plus"></i> Add Implementing Office</a></li>
                </ol>
                ...
                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    {!!Form::open(['route'=>'implementingoffice.store','method'=>'post','class'=>'showSavingOnSubmit','files'=>true])!!}
                    <div class="col-md-8 col-lg-8" data-appear-animation="fadeInLeft" data-appear-delay="1200">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title pull-left"><span class="glyphicon glyphicon-plus"></span> Add Implementing Office</h3>
                            ...
                            <div class="panel-body collapse in" id="pro_collapse_add_save">
                                ...
                                <div class="form-group col-md-6 col-lg-6 @if($errors->has('chief')) has-error @elseif(count($errors->all())>0) has-success @endif has-feedback">
                                    <div class="input-group pro_make_full showToolTip">
                                        ...
                                        {!! Form::select('cheif_id', $cheifs, null, ['class'=>'form-control']) !!}
                                        @if($errors->has('chief'))
                                            <span class="glyphicon glyphicon-remove-circle form-control-feedback" aria-hidden="true"></span>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body collapse" id="pro_collapse_port_map">
                                ...
                                <div class="form-group input-group @if(count($errors->all())>0){{($errors->has('coordinates'))?'has-error':'has-success'}}@endif col-lg-12 col-md-12">
                                    <input type='hidden' size='38' maxlength='40' name='coordinates' id='coordinates' value='27.700855895121396, 85.28978346679685' class="form-control" readonly />
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body collapse in" id="pro_collapse_tree">
                                ...
                                {{--<div class="form-group col-md-6 col-lg-6 @if($errors->has('office_code')) has-error @elseif(count($errors->all())>0) has-success @endif has-feedback">--}}
                                    ...
                                    {{--</div>--}}
                                {{--</div>--}}
                                {!! Form::hidden('implementing_office_id','1',['id'=>'implementing_office_id']) !!}
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body collapse in" id="pro_collapse_implementingoffice_save">
                                ...
                                <div class="form-group col-md-12 col-lg-12 pro_checkbox pro_no_top">
                                    <input type="checkbox" name="is_monitoring" id="is_monitoring" class="third" />
                                    <label for="is_monitoring">Is Monitoring?</label>
                                </div>
                                <!-- is_physical_office -->
                                <div class="form-group col-md-6 col-lg-6 pro_checkbox pro_no_top">
                                    <input type="checkbox" name="is_physical_office" id="is_physical_office" class="second_color" checked="checked"/>
                                    <label for="is_physical_office">Is Physical Office?</label>
                                </div>
                                <!-- is_last_node -->
                                <div class="form-group col-md-12 col-lg-12 pro_checkbox pro_no_top">
                                    <input type="checkbox" name="is_last_node" id="is_last_node" class="first_color" />
...
@section('footerContent')
    ...
    <script type="text/javascript">
        ...
        $('#district_id').change(function(){
            ...
            $('#name').val('सघन सहरी तथा भवन निर्माण आयोजना, '+district_name);
            $('#name_eng').val('Federal Planning Implementation Unit, '+district_eng);
        });
