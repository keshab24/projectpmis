                ...
                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="table-responsive pro_hide_y centered">
                            {!!Form::open(['route'=>'report.contract_info.post','method'=>'post','class'=>'showSavingOnSubmit'])!!}
                            <table class="table table-striped table-hover col-offset-6 centered">
                                ...
                                <tr>
                                    <th>
                                        आर्थिक बर्ष छान्नुहोस्
                                    </th>
                                </tr>
                                <tr>
                                    <td>
                                        {!! Form::select('fiscal_year_id',$fiscal_year,null,['class'=>'form-control']) !!}
                                    </td>
                                </tr>
                                <tr>
                                    <th>
