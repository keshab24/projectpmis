        ...
        <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb" data-appear-animation="fadeInRight" data-appear-delay="600">
                    ...
                    <li><a href="{{route('state.index')}}"><i class="fa fa-buysellads"></i> State</a></li>
                    <li class="active"><a href="{{route('state.create')}}"><i class="fa fa-plus"></i> Add State</a></li>
                </ol>

                <div class="pro_helpers" data-appear-animation="fadeInDown" data-appear-delay="800">
                    <div class="col-lg-6 col-md-6">
                        <a href="{{route('state.index')}}" class="btn btn-info showToolTip" title="Edit State" role="button" data-placement="top"><span class="glyphicon glyphicon-eye-open"></span> <span class="hidden-xs hidden-sm">Show States</span></a>
                    </div>
                    <div class="clearfix"></div>
                </div>

                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    {!!Form::model($state, ['route'=>['state.update', $state->slug],'method'=>'put','class'=>'showSavingOnSubmit','files'=>true])!!}
                    <div class="col-md-8 col-lg-8" data-appear-animation="fadeInLeft" data-appear-delay="1200">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title pull-left"><span class="glyphicon glyphicon-plus"></span> Add State</h3>
                                {!! minimizeButton('pro_collapse_state') !!}
                            </div>
                            <div class="panel-body collapse in" id="pro_collapse_state">
                                ...
                                <!-- state_number -->
                                <div class="form-group col-md-6 col-lg-6 @if($errors->has('state_number')) has-error @elseif(count($errors->all())>0) has-success @endif has-feedback">
                                    <div class="input-group pro_make_full showToolTip">
                                        {!! Form::label('state_number','State Number') !!}
                                        {!! Form::text('state_number', null, ['class'=>'form-control']) !!}
                                        @if($errors->has('state_number'))
                                            <span class="glyphicon glyphicon-remove-circle form-control-feedback" aria-hidden="true"></span>
                                            <span id="state_numberStatus" class="sr-only">(error)</span>
                                            <div class="alert alert-danger"><small><i class="fa fa-warning"></i> {!! $errors->first('state_number') !!}</small></div>
                                        @elseif(count($errors->all())>0)
                                            <span class="glyphicon glyphicon-ok-circle form-control-feedback" aria-hidden="true"></span>
                                            <span id="state_numberStatus" class="sr-only">(success)</span>
                                        @endif
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                    ...
                    <div class="col-md-4 col-lg-4 pro_content_right" data-appear-animation="fadeInRight" data-appear-delay="1200">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                {!! minimizeButton('pro_collapse_state_save') !!}
                            </div>
                            <div class="panel-body collapse in" id="pro_collapse_state_save">
                                <!-- status -->
