        ...
        <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb" data-appear-animation="fadeInRight" data-appear-delay="600">
                    ...
                    <li class="active"><a href="{{route('manpower.create')}}"><i class="fa fa-plus"></i> Add Manpower</a></li>
                </ol>
                ...
                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    {!!Form::open(['route'=>'manpower.store','method'=>'post','class'=>'showSavingOnSubmit'])!!}
                            ...
                            <div class="panel-body collapse in" id="pro_collapse_month">
                                 ...
                                 <div class="form-group col-md-12 col-lg-12 @if($errors->has('type')) has-error @elseif(count($errors->all())>0) has-success @endif has-feedback">
                                    <div class="input-group pro_make_full showToolTip" @if($errors->has('type')) type="{!!$errors->first('type')!!}" @endif>
                                        {!! Form::label('type','Associated with:') !!}
                                ...
                                <div class="form-group col-md-6 col-lg-6 pro_checkbox pro_no_top">
                                    <input type="checkbox" name="countable" id="countable" class="first_color" />
