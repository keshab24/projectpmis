                ...
                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="table-responsive pro_hide_y centered">
                            {!!Form::open(['route'=>'hbms.report.view','method'=>'get','class'=>'showSavingOnSubmit','files'=>true])!!}
                            <table class="table table-striped table-hover col-offset-6 centered">
                                ...
                                <tr>
                                    <td>
                                        {!! Form::select('fiscal_year',$fiscal_year,null,['class'=>'form-control','id'=>'fiscal_year']) !!}
                                    </td>
                                </tr>
                                <tr>
                                    <th>
