                ...
                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="table-responsive pro_hide_y centered">
                            {!!Form::open(['route'=>'hbms.group_report.post','method'=>'POST','class'=>'showSavingOnSubmit','files'=>true])!!}
                            <table class="table table-striped table-hover col-offset-6 centered">
                                ...
                                <tr>
                                    <th>
                                        सुरु भएको आ.ब {!! Form::checkbox('till_now',1,false) !!} सम्मको
                                    </th>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        {!! Form::select('show_on_running',array('All Projects','Running','Terminated','Cancelled'),0,['class'=>'form-control','id'=>'fy_id']) !!}
                                    </td>
                                </tr>
                            </table>
