                ...
                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="table-responsive pro_hide_y centered">
                            {!!Form::open(['route'=>'hbms.handover.post','method'=>'POST','class'=>'showSavingOnSubmit','files'=>true])!!}
                            <table class="table table-striped table-hover col-offset-6 centered">
                                ...
                                <tr>
                                    <th>
                                        कार्यक्रम सकिएको आ.व.
                                    </th>
                                </tr>
                                <tr>
                                    <td>
                                        {!! Form::select('fy_id',$pro_fiscal_years,null,['class'=>'form-control','id'=>'fy_id']) !!}
                                    </td>
                                </tr>
                            </table>
