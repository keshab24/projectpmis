        ...
        <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb" data-appear-animation="fadeInRight" data-appear-delay="600">
                    ...
                    <li class="active"><a href="{{route('sector.create')}}"><i class="fa fa-plus"></i> Add Sector</a></li>
                </ol>
                ...
                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    {!!Form::open(['route'=>'sector.store','method'=>'post','class'=>'showSavingOnSubmit','files'=>true])!!}
                            ...
                            <div class="panel-body collapse in" id="pro_collapse_sector">
                                ...
                                <div class="form-group col-md-6 col-lg-6 @if($errors->has('name')) has-error @elseif(count($errors->all())>0) has-success @endif has-feedback">
                                    <div class="input-group pro_make_full showToolTip">
                                        {!! Form::label('name','Sector Name (नेपालीमा):') !!}
                                ...
                                <div class="form-group col-md-6 col-lg-6 @if($errors->has('name_eng')) has-error @elseif(count($errors->all())>0) has-success @endif has-feedback">
                                    <div class="input-group pro_make_full showToolTip">
                                        {!! Form::label('name_eng','Sector (Urban/Housing/...):') !!}
