    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb" data-appear-animation="fadeInRight" data-appear-delay="600">
                ...
                <li>Print Allocated Activities for F.Y. {{\PMIS\Fiscalyear::whereId(session()->get('pro_fiscal_year'))->first()->fy}}</li>
            </ol>
            ...
            <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="table-responsive pro_hide_y centered">
                        {!!Form::open(['route'=>'report.allocation.post','method'=>'post','class'=>'showSavingOnSubmit','files'=>true])!!}
