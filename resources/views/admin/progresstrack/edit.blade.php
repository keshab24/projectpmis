        ...
        <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb" data-appear-animation="fadeInRight" data-appear-delay="600">
                    ...
                    <li><a href="{{route('progresstrack.index')}}"><i class="fa fa-buysellads"></i> Progress Track</a></li>
                    <li class="active"><a href="{{route('progresstrack.create')}}"><i class="fa fa-edit"></i> Edit Progress Track</a></li>
                </ol>

                <div class="pro_helpers" data-appear-animation="fadeInDown" data-appear-delay="800">
                    <div class="col-lg-6 col-md-6">
                        <a href="{{route('progresstrack.index')}}" class="btn btn-info showToolTip" title="Edit Progress Track" role="button" data-placement="top"><span class="glyphicon glyphicon-eye-open"></span> <span class="hidden-xs hidden-sm">Show Progress Tracks</span></a>
                    </div>
                    <div class="clearfix"></div>
                </div>

                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    {!!Form::model($progresstrack,['route'=>['progresstrack.update',$progresstrack->slug],'method'=>'put','class'=>'showSavingOnSubmit','files'=>true])!!}
