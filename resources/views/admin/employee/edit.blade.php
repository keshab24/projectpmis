        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    {!!Form::model($employee, ['route'=>['employee.update', $employee->slug],'method'=>'put','class'=>'showSavingOnSubmit','files'=>true])!!}
                            ...
                            <div class="panel-body collapse in" id="pro_collapse_employee">
                                ...
                                <div class="form-group col-md-6 col-lg-6 @if($errors->has('district')) has-error @elseif(count($errors->all())>0) has-success @endif has-feedback">
                                    <div class="input-group pro_make_full showToolTip"
                                        ...
                                        {!! Form::select('district', $districts, $employee->district_id, ['class'=>'form-control']) !!}
                    ...
                    <div class="col-md-4 col-lg-4 pro_content_right" data-appear-animation="fadeInRight"
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                {!! minimizeButton('pro_collapse_employee_image') !!}
                            </div>
                            <div class="panel-body collapse in" id="pro_collapse_employee_image">
                                <div class="pro_image_preview">
                                    @if($employee->image !='' && $employee->image != NULL && file_exists('public/images/employee/original/orivtx'.$employee->image))
                                        <img src="{{asset('public/images/employee/original/orivtx'.$employee->image)}}" alt="{{$employee->image}}" title="{{$employee->name}}" class="img img-responsive showToolTip" />
                                    @else
                            ...
                            <div class="panel-body collapse in" id="pro_collapse_employee_save">
                                ...
                                <div class="form-group col-md-3 col-lg-3 pro_checkbox pro_no_top">
                                    <input type="checkbox" name="status" id="status" class="first_color"
                                           @if($employee->status  == 1) checked="checked" @endif/>
                                    <label for="status">Is Active?</label>
                                </div>
                                <!-- providend_fund -->
                                <div class="form-group col-md-4 col-lg-4 pro_checkbox pro_no_top">
                                    <input type="checkbox" name="pf" id="pf" class="second_color"@if($employee->providend_fund ==1) checked @endif/>
                                    <label for="pf">Providend Fund</label>
                                </div>
                                <!-- cit -->
                                <div class="form-group col-md-5 col-lg-5 pro_checkbox pro_no_top">
                                    <input type="checkbox" name="cit" id="cit" class="second_color"@if($employee->citizen_investment_trust  == 1) checked @endif/>
