            ...
            <div class="col-md-12">
                <ol class="breadcrumb" data-appear-animation="fadeInRight" data-appear-delay="600">
                    <li><a href="{{route('home')}}"><span class="glyphicon glyphicon-blackboard"></span>
                            Dashboard</a></li>
                    <li><a href="{{route('vendor.index')}}"><i class="fa fa-buysellads"></i> Vendor</a>
                    </li>
                    <li class="active"><a href="{{route('vendor.create')}}"><i class="fa fa-plus"></i>
                            Add Vendor</a></li>
                </ol>

                <div class="pro_helpers" data-appear-animation="fadeInDown" data-appear-delay="800">
                    <div class="col-lg-6 col-md-6">
                        <a href="{{route('vendor.index')}}" class="btn btn-info showToolTip"
                           title="Edit Vendor" role="button" data-placement="top"><span
                                    class="glyphicon glyphicon-eye-open"></span> <span class="hidden-xs hidden-sm">Show Vendors</span></a>
                    </div>
                    <div class="clearfix"></div>
                </div>

                <div class="pro_content" data-appear-animation="fadeInUp" data-appear-delay="1000">
                    {!!Form::model($vendor, ['route'=>['vendor.update', $vendor->slug],'method'=>'put','class'=>'showSavingOnSubmit','files'=>true])!!}
                            ...
                            <div class="panel-body collapse in" id="pro_collapse_vendor">
                                ...
                                <div class="form-group col-md-12 col-lg-12 @if($errors->has('description')) has-error @elseif(count($errors->all())>0) has-success @endif has-feedback">
                                    <div class="input-group pro_make_full showToolTip">
                                        ...
                                        {!! Form::text('description', null, ['class'=>'form-control','rows'=>4]) !!}
                                    ...
                                    @foreach($files as $file)
                                        ...
                                        <span class="glyphicon glyphicon-remove-circle closeButton"
                                            ...
                                            <label for="file{{$i}}" class="noBorder"><img
                                                        src="{{asset('public/vendorFiles/'.$file)}}"
                                                        title="" alt=""/> </label>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body collapse in" id="pro_collapse_vendor_image">
                                <div class="pro_image_preview">
                                    @if($vendor->image !='' && $vendor->image != NULL && file_exists('public/images/vendor/original/orivtx'.$vendor->image))
                                        <img src="{{asset('public/images/vendor/original/orivtx'.$vendor->image)}}" alt="{{$vendor->image}}" title="{{$vendor->name}}" class="img img-responsive showToolTip" />
                                    @else
