	...
	Croppic.prototype = {
		...
		afterCrop: function (data) {
            ...
            if (response.status == 'success') {
                ...
                that.obj.append('<img class="croppedImg" src="' +$home_path+'/public/admin/plugin/croppic/'+ response.url + '">');
            ...
            /* by vtx mg */
            that.obj.append('<input name="animation_image_name" value="'+response.url+'" type="hidden" />')
            /* end */
