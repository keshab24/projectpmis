...
trait DateConverterTrait{
     ...
     * @return array
     */
    public function eng_to_nep($eng_date)
    {
        ...
        if ($chk !== TRUE) {
            ...
            $this->_nep_date['full_date'] = $y.'-'.sprintf('%02d',$m).'-'.sprintf('%02d',$total_nDays);
     ...
     * @return array
     */
    public function nep_to_eng($nep_date)
    {
        $date = explode('-',$nep_date);
        $yy = $date[0];
        $mm = $date[1];
        $dd = $date[2];
        ...
        if ($chk !== TRUE) {
            ...
            $this->_eng_date['full_date'] = $y.'-'.sprintf('%02d',$m).'-'.sprintf('%02d',$total_eDays);
