...
class ProgressTrack extends Model
{
    ...
    protected $table = 'pro_progress_tracks';
     ...
     * @var array
     */
    protected $fillable = ['storey_area', 'slug', 'progress_type', 'progress', 'progress_eng', 'physical_percentage', 'monitoring_office_id', 'status'];
